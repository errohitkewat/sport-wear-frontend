  ...
  return (
    <footer className="bg-slate-950 text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-7 text-slate-400">
            Modern sports clothing store with clean style, premium quality, and
            comfortable activewear for daily performance.
          </p>
        ...
        <div>
          ...
          <div className="mt-5 flex flex-col gap-3 text-sm text-slate-400">
            ...
            <Link to="/women" className="transition hover:text-orange-400">
              Women
            </Link>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-5 text-center text-sm text-slate-500 sm:px-6 md:flex-row lg:px-8">
